...
2. Copia cadascun dels exemples següents i posa'ls en marxa.
   - **#1a** Actualitzant el valor cada 500ms:
     ...
     ![Increment cada 500ms](../../images/increment_500ms.png)
   ...
   - **#1b** Actualitzant el valor quan es prem un botó:
     ...
     ![Increment amb botó](../../images/increment_button.png)
   ...
   - **#1c** Actualitzant el valor en un comptador enrere:
     ...
     ![Increment en compte enrere](../../images/increment_countdown.png)
...
![Sprite en espiral](../../images/sprite_espiral.png)
...
![Fórmula d'increment](../../images/increment_formula.png)
...
- Exemple:
  ...
  ![Fixar variable](../../images/set_variable.png)
