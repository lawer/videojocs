...
![](../../images/downloaded_variable-math.gif)
...
![Equació matemàtica en variable](../../images/variables_1.png)
...
let primerNombre = 15
let segonNombre = 5
let resposta = primerNombre - segonNombre
game.splash("15 - 5 = " + resposta)
primerNombre = 5
segonNombre = 7
resposta = primerNombre * segonNombre
game.splash("5 * 7 = " + resposta)
```
...
![Operacions amb variables](../../images/variables_2.png)
