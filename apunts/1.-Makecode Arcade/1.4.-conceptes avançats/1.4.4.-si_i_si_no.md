...
if (info.score() < info.highScore()) {
    game.splash("Segueix jugant!")
} else {
    game.splash("Enhorabona! Has superat el record!!")
}
```
...
![Bloc si i si no](../../images/si_i_si_no.png)
...
![Bloc si no, si](../../images/si_no_si.png)
...
```blocks
function generar() {
    botoSeleccionat = randint(0, 1)
    if (botoSeleccionat == 0) {
        mySprite.sayText("polsa A")
    }
    if (botoSeleccionat == 1) {
        mySprite.sayText("polsa B")
    }
}
...
let botoSeleccionat = 0
let mySprite: Sprite = null
game.splash("Polsa A o B segons", "diga el missatge")
...
![Missatge aleatori](../../images/missatge_aleatori.png)
...
![Verifica botó premut](../../images/boto_premut.png)
...
![Utilització de si no](../../images/boto_si_no.png)
...
- Què és el mateix i què és diferent entre els següents exemples de codi? Quin és més fàcil de llegir? Explica.
  ...
  ![Exemple elif](../../images/ex_elif.png)
  ...
  ![Exemple si anidat](../../images/ex_si_anidat.png)
